...
//           rows={3}
//           className="mt-1 w-full rounded-lg border border-gray-200 p-2 text-sm focus:ring-2 focus:ring-blue-500"
//         />
//       </div>
...
//         <label className="mt-1 flex items-center gap-2 cursor-pointer text-sm text-blue-600">
